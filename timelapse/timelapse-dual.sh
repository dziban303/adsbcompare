...
set output pwd.'/frames/tl-'.frame.'.png'
...
cd $dir/frames
ffmpeg -framerate 120 -i tl-%05d.png -pix_fmt yuv420p -r 60 timelapse.mp4
mv timelapse2.mp4 $dir
